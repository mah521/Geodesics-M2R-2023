...
def plot_plane_and_torus(f, normal_f, point_2d_list, epsilon):
    ...
    fig2.update_layout(scene=dict(xaxis_title='', yaxis_title='', zaxis_title='',xaxis_showgrid=False, yaxis_showgrid=False, zaxis_showgrid=False))
    fig2.show()
...
def gradient_L(point_2d_list):
    ...
    for i in range(len(point_2d_list)):
        if i == 0:  # First point
            new_val = np.add(H(point_2d_list[i], point_2d_list[i+1]), H(point_2d_list[n], point_2d_list[n-1]))
        elif i == n:  # Last point
            new_val = np.add(H(point_2d_list[0], point_2d_list[1]), H(point_2d_list[n], point_2d_list[n-1]))
        else:  # Other points
            new_val = np.add(H(point_2d_list[i], point_2d_list[i-1]), H(point_2d_list[i], point_2d_list[i+1]))
